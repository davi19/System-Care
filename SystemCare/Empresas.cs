...
namespace SystemCare
{
    public partial class Empresas : MetroForm
    {
        ...
        {
            DataTable TabelaResultadoEmpresa = Cadastro.BuscaEmpresa(TextBusca.Text);
        ...
        private void BtnEditar_Click(object sender, EventArgs e)
        {
            if (BtnEditar.Text.Equals("Editar"))
            {
                ...
                else
                {
                    ...
                    LabelCnaeEditar.Text = "CNAE |" + TabelaEditarEmpresa.Rows[0][6].ToString();
            ...
            {
                string[] Cnae = LabelCnaeEditar.Text.Split('|');
                Cadastro.EditarEmpresa(TextNomeEditar.Text, TextEnderecoEditar.Text, TextCnpjEditar.Text,
                        Convert.ToInt32(TextQuantidadeFuncionarioEditar.Text), TextTelefoneEditar.Text, TextEmailEditar.Text, Cnae[1] + " " +
                                                                                                            "| " + Cnae[2],
        ...
        private void BtnCnaeEditar_Click(object sender, EventArgs e)
        {
            ...
            {
                DataTable TabelaResultadoBuscaCnae = Cadastro.BuscaCnae(TextBuscaCnaeEditar.Text);
        ...
        {
            LabelCnaeEditar.Text = "CNAE | " + DataViewCnae.Rows[e.RowIndex].Cells[0].Value + " | " + DataViewCnae.Rows[e.RowIndex].Cells[1].Value;
