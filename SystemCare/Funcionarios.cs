    ...
    public partial class Funcionarios : MetroForm
    {
        ...
        private void BtnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            Cadastro.CadastraFuncionario(TextNomeFuncionario.Text, TextIdade.Text, Sexo,
                Convert.ToDecimal(TextAltura.Text), Convert.ToDecimal(TextPeso.Text),
        ...
        private void BtnEditar_Click(object sender, EventArgs e)
        {
            ...
            {
                for (int i = 0; i < GridFuncionarioEditar.Rows.Count; i++)
                {
                    try
                    {
                ...
                else
                {
                    ...
                    for (int i = 0; i < GridFuncaoFuncionarioEditar.Rows.Count; i++)
                    {
                        try
                        {
                            if (
        ...
        private void BtnBuscaFuncaoEditar_Click(object sender, EventArgs e)
        {
            ...
            DataTable TabelaFuncao = Cadastro.BuscaFuncao(TextBuscaFuncaoEditar.Text);
